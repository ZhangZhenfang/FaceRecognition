...
export default {
  ...
  methods: {
    ...
    updateUser () {
      this.axios.post(urls.api + '/user/updateUser', this.qs.stringify(this.u)).then((response) => {
    ...
    addUser () {
      ...
      this.axios.post(urls.api + '/user/addUser', this.qs.stringify({
    ...
    listNextPage (pageNumber, pageSize) {
      this.axios.post(urls.api + '/user/listAllUser', this.qs.stringify({
    ...
    countAllUser () {
      this.axios.get(urls.api + '/user/countAllUser').then((response) => {
        // console.log(response)
        if (response.data.status === 1) {
