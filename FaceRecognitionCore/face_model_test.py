...
def define_model(x, super_params, keep_prob):
    ...
    with tf.variable_scope("fc1"):
        ...
        fc1_flat = tf.reshape(pool4, [-1, conv_out_height * conv_out_width * input_channel])
